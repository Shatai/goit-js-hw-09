...
timerElement.style.cssText = `display: flex; margin-right: 20px; width: 300px; text-align: center;`;
daysValue.style.fontSize = 40 + 'px';
hoursValue.style.fontSize = 40 + 'px';
minutesValue.style.fontSize = 40 + 'px';
secondsValue.style.fontSize = 40 + 'px';